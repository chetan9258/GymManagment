...
export declare class AppComponent implements OnInit {
    ...
    currencyFormatting(value: number): string;
    ...
    bubbleDemoProcess(dataFromServer: any): void;
    getBubbleInteractiveTitle(): string;
    bubbleShowDrilldownResetLink(): boolean;
    onClickResetBubbleInteractiveDrill(): void;
    onSelectBubbleInteractivePoint(event: any): void;
}
